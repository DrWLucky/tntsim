...
void TntPhysicsList::ConstructParticle()
{
  ...
  // leptons - Construct all leptons (for Binary Cascade Model)
...
void TntPhysicsList::ConstructProcess()
{
...
void TntPhysicsList::ConstructEM()
{
...
void TntPhysicsList::ConstructNuclear()
{
