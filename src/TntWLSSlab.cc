...
// ********************************************************************
//
// $Id: TntWLSSlab.cc 77486 2013-11-25 10:14:16Z gcosmo $
//
/// \file optical/Tnt/src/TntWLSSlab.cc
/// \brief Implementation of the TntWLSSlab class
//
//
#include "TntWLSSlab.hh"
#include "TntWLSFiber.hh"
...
G4LogicalVolume* TntWLSSlab::fScintSlab_log=NULL;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

TntWLSSlab::TntWLSSlab(G4RotationMatrix *pRot,
                 ...
                 "Slab",pMotherLogical,pMany,pCopyNo),fConstructor(c)
{
  ...
  for(G4int i=0;i<fNfibers;i++){
     ...
     new TntWLSFiber(rm,G4ThreeVector(0.,Y,0.),fScintSlab_log,false,0,
                     fConstructor);
  }
