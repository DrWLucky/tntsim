/// \file Units.hh
/// \brief Clone G4SystemOfUnits, but in the tntsim namespace
...
///  has to be withing the tntsim namespace - otherwise prefix units with
///  tntsim:: (or, if you prefer, CLHEP::).
///
