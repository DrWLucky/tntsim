/// \file Units.hh
/// \brief Clone G4SystemOfUnits, but in the texansim namespace
/// \details Include this file instead of G4SystemOfUnits.hh, and you'll
///  avoid any naming conflicts between the units and outside libraries
///  (e.g. the plethora of warnings generated by TString because it uses
///  's' as a local variable in functions. For "seamless" use, everything
///  has to be withing the texansim namespace - otherwise prefix units with
///  texansim:: (or, if you prefer, CLHEP::).
///
#ifndef TXS_UNITS_HEAD_ER_F_I_L_E
#define TXS_UNITS_HEAD_ER_F_I_L_E
