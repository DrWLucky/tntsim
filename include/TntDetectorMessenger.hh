...
// ********************************************************************
//
// $Id: TntDetectorMessenger.hh 77486 2013-11-25 10:14:16Z gcosmo $
//
/// \file optical/Tnt/include/TntDetectorMessenger.hh
/// \brief Definition of the TntDetectorMessenger class
//
//
#ifndef TntDetectorMessenger_h
#define TntDetectorMessenger_h 1

#include "G4UImessenger.hh"
#include "globals.hh"

class TntDetectorConstruction;
class G4UIdirectory;
...
class TntDetectorMessenger: public G4UImessenger
{
  public:

    TntDetectorMessenger(TntDetectorConstruction*);
    virtual ~TntDetectorMessenger();
 
    virtual void SetNewValue(G4UIcommand*, G4String);
 
  private:

    TntDetectorConstruction*     fTntDetector;
