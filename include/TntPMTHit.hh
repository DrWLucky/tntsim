...
// ********************************************************************
//
// $Id: TntPMTHit.hh 72250 2013-07-12 08:59:26Z gcosmo $
//
/// \file optical/Tnt/include/TntPMTHit.hh
/// \brief Definition of the TntPMTHit class
//
//
#ifndef TntPMTHit_h
...
class TntPMTHit : public G4VHit
{
  public:
 
    TntPMTHit();
    virtual ~TntPMTHit();
    TntPMTHit(const TntPMTHit &right);

    const TntPMTHit& operator=(const TntPMTHit &right);
    G4int operator==(const TntPMTHit &right) const;
...
typedef G4THitsCollection<TntPMTHit> TntPMTHitsCollection;

extern G4ThreadLocal G4Allocator<TntPMTHit>* TntPMTHitAllocator;

inline void* TntPMTHit::operator new(size_t){
  if(!TntPMTHitAllocator)
      TntPMTHitAllocator = new G4Allocator<TntPMTHit>;
  return (void *) TntPMTHitAllocator->MallocSingle();
}

inline void TntPMTHit::operator delete(void *aHit){
  TntPMTHitAllocator->FreeSingle((TntPMTHit*) aHit);
}
